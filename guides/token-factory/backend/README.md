...
```
./bin/run transaction:create tokenFactory createToken 10000000 --params='{"name":"The real pepe", "symbol": "PEPE2", "totalSupply": 1200000}' --json --pretty
...
./bin/run endpoint:invoke token_getBalances '{"address":"klys9u6yy466q2mpbj92cmbp64eg7gvpuz7v4efm8"}' --pretty
